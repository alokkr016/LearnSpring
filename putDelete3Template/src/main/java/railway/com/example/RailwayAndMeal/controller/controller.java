...
public class controller {
	...
	// add annotations in the method parameter to validate the request body as
	// designed in the entity class.
	// add annotation for handling error if the data is invalid using the
	// BindingResult class.
	@PostMapping("/ticket")
	public void addTicket(@Valid @RequestBody Ticket ticket, BindingResult bindingResult) {
		if (bindingResult.hasErrors()) {
			throw new TicketBodyInvalidException("Invalid ticket data");
		}

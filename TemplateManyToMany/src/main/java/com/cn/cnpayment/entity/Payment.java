...
public class Payment {
	...
	public Payment(int id, String paymentType, String description, PaymentDetails paymentDetails, List<PaymentReview> paymentReviews, List<Orders> orders) {
		this.id = id;
		this.paymentType = paymentType;
		this.description = description;
	...
	//add required getter setter for Order.


	@ManyToMany(fetch = FetchType.EAGER,cascade = {CascadeType.MERGE,CascadeType.PERSIST,CascadeType.REFRESH})
	@JsonIgnore
	@JoinTable(name = "payment_orders",joinColumns=@JoinColumn(name = "payment_id"),inverseJoinColumns = @JoinColumn(name = "order_id"))

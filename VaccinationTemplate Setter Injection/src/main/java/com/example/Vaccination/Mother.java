 ...
 * 4. TimeAndLocation(class), vaccine(interface), both are injected by the
 * constructor method.
 * 5. The arguments of the constructor for all users should be like "public
 * User(TimeAndLocation timeAndLocation, Vaccine vaccine)"
...
public class Mother implements User {
  ...
  public void setAppointment() {
    System.out.println("Hello " + name + " your appointment has been fixed for " + vaccine.getType()
